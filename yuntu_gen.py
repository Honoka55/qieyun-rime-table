...
def 輸出網頁文件(文件名):
    ...
    with open(文件名, 'w', encoding='utf-8') as 文件:
        文件.writelines('\n'.join([
            ...
            '<link rel="canonical" href="https://honoka55.github.io/qieyun-rime-table/">',
            '<meta property="og:type" content="article">',
            '<meta property="og:title" content="切韵新韵图">',
            f'<meta property="og:description" content="{首段}">',
            '<meta property="og:url" content="https://honoka55.github.io/qieyun-rime-table/">',
            '<meta property="og:site_name" content="焰色升空，华樱落尘">',
            ...
            '<p><em>特别提醒：本分支是由焰华<hanla></hanla>Honoka55<hanla></hanla>添加<hanla></hanla>webfont<hanla></hanla>支持的版本，所用字体子集化自<hanla></hanla><a href="https://kamichikoichi.github.io/jigmo/" title="Jigmo fonts" target="_blank">Jigmo fonts</a>。您也可以前往<a href="https://phesoca.com/rime-table/" title="切韻新韻圖" target="_blank">绯索卡</a>阅读官方原版。</em></p>',
            f'<p>{首段}</p>',
        ...
        文件.writelines('\n'.join([
            ...
            '</div>',
            '<div class="footer">'
            '<div><a href="https://phesoca.com/rime-table/data.txt" download="廣韻小韻數據（unt修訂）">下載<hanla></hanla>unt<hanla></hanla>修訂的廣韻小韻數據（txt<hanla></hanla>格式</a> / <a href="https://phesoca.com/rime-table/data.xlsx" download="廣韻小韻數據（unt修訂）">xlsx<hanla></hanla>格式）</a></div>',
            '<div><a href="https://phesoca.com/rime-table/rev.xlsx" download="廣韻爭議小韻整理">下載<hanla></hanla>unt<hanla></hanla>的廣韻爭議小韻整理表（未完成）</a></div>',
            '<div><a href="https://github.com/Honoka55/qieyun-rime-table">查看本分支的<hanla></hanla>GitHub<hanla></hanla>項目</a></div>',
            '<div><a href="https://honoka55.github.io/">返回焰华<hanla></hanla>Honoka55<hanla></hanla>的博客首页</a></div>',
            '</div>',
            '</div>', '</div>', '</body>',
            '</html>',
        ]))
